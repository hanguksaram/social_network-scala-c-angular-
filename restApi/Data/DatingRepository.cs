...
namespace API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        public async Task<Photo> GetPhoto(int id) => await _context.Photos.FirstOrDefaultAsync(p => p.Id == id) ?? new Photo();
        ...
        public async Task<PagedList<User>> GetUsers(UserParams userParams)
        {
            ...
            if (userParams.MinAge != 18 || userParams.MaxAge != 99) {
                ...
                var maxDop = DateTime.Today.AddYears(-userParams.MinAge);

                users = users.Where(u => u.DateOfBirth >= minDob && u.DateOfBirth <= maxDop); 
            }
        ...
        private async Task<IEnumerable<int>> GetUserLikes(int id, bool likers) {
            //this method will generate obviously worst sql query ever
